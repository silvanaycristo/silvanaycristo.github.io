...
## En la tabla de coeficientes nos dice el estimado de beta 0 1 y 2
...
## 1) Pre v.s post da el orden donde un valor positivo indica mayor expresión en el pre.
## 2) Individuo constante.
## 3) La respuesta es resistente.
